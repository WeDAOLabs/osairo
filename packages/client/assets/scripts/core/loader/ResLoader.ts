...
export type IRemoteOptions = any;
...
export default class ResLoader {
  ...
  private loadByBundleAndArgs<T extends Asset>(
  ...
  public releaseDir(path: string, bundleName: string = 'resources') {
    const bundle: AssetManager.Bundle | null =
  ...
  public get<T extends Asset>(
    ...
    const bundle: AssetManager.Bundle | null =
      assetManager.getBundle(bundleName);
    console.log('bundle', bundleName, bundle, path);
  ...
  public dump() {
    ...
    console.log(`total res:${assetManager.assets.count}`);
  }
}
